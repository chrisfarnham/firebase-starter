...
var temp__5752__auto__ = (function (){var temp__5752__auto__ = (devtools.munging.get_global_scope.call(null)["cljs"]);
if(cljs.core.truth_(temp__5752__auto__)){
var o46069 = temp__5752__auto__;
var temp__5752__auto____$1 = (o46069["core"]);
if(cljs.core.truth_(temp__5752__auto____$1)){
var o46070 = temp__5752__auto____$1;
return (o46070["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
if(cljs.core.truth_(temp__5752__auto__)){
var js_reserved_fn = temp__5752__auto__;
...
var o__45643__auto__ = f;
return (o__45643__auto__["toString"]).call(o__45643__auto__);
} else {
return "";
}
...
try{var o__45643__auto___46258 = t;
(o__45643__auto___46258["cljs$lang$ctorPrWriter"]).call(o__45643__auto___46258,t,writer);
}catch (e46078){var __46259 = e46078;
}
...
var char_code = (function (){var o__45643__auto__ = (new String(char$));
return (o__45643__auto__["charCodeAt"]).call(o__45643__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__45643__auto__ = String;
return (o__45643__auto__["fromCharCode"]).call(o__45643__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__46087 = num_code;
switch (G__46087) {
case (1):
return (185);
...
var o__45643__auto__ = String;
return (o__45643__auto__["fromCharCode"]).call(o__45643__auto__,superscript_code);
});
/**
...
var temp__5752__auto__ = cljs.core.second(cljs.core.re_find(/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5752__auto__)){
var meat = temp__5752__auto__;
var temp__5752__auto____$1 = cljs.core.re_find(/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5752__auto____$1)){
var match = temp__5752__auto____$1;
...
}catch (e46101){var _e__45680__auto__ = e46101;
return false;
}})())){
...
var vec__46102 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46102,(0),null);
...
var or__4126__auto__ = (function (){var temp__5752__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5752__auto__)){
var m = temp__5752__auto__;
...
var temp__5756__auto__ = goog.object.getValueByKeys(devtools.munging.get_global_scope.call(null),ns_module_name.split("."));
if((temp__5756__auto__ == null)){
return null;
} else {
var ns_obj = temp__5756__auto__;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__46119){
var vec__46120 = p__46119;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46120,(0),null);
...
var G__46282 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__46283 = cljs.core.butlast(remaining_tokens);
name_tokens = G__46282;
remaining_tokens = G__46283;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq46115){
var G__46116 = cljs.core.first(seq46115);
var seq46115__$1 = cljs.core.next(seq46115);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46116,seq46115__$1);
}));
...
var vec__46133 = cljs.core.split_with((function (p1__46131_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__46131_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46133,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46133,(1),null);
...
var vec__46146 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46146,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46146,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__46287 = cljs.core.rest(remaining_tokens);
var G__46288 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__46287;
name_tokens = G__46288;
continue;
} else {
...
var vec__46151 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46151,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46151,(1),null);
var vec__46154 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46154,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46154,(1),null);
var vec__46157 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46157,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46157,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46157,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46157,(3),null);
...
var vec__46163 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46163,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46163,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46163,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46163,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46163,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46163,(5),null);
...
var temp__5752__auto__ = devtools.munging.parse_fn_source(fn_source);
if(cljs.core.truth_(temp__5752__auto__)){
var vec__46170 = temp__5752__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46170,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46170,(1),null);
var vec__46173 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46173,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46173,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__46177 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__46177) : devtools.munging.parse_fn_info_deep.call(null,G__46177));
})()));
}
} else {
return fn_info;
...
var temp__5752__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(state,prefix);
if(cljs.core.truth_(temp__5752__auto__)){
var subscript = temp__5752__auto__;
...
var G__46312 = (arity + (1));
var G__46313 = (function (){var temp__5752__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5752__auto__)){
var arity_fn = temp__5752__auto__;
...
var temp__5752__auto__ = devtools.munging.get_fn_variadic_arity(f);
if(cljs.core.truth_(temp__5752__auto__)){
var variadic_arity = temp__5752__auto__;
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__46191){
var vec__46194 = p__46191;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46194,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46194,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46201_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__46201_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46202_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__46202_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__46206){
var vec__46207 = p__46206;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46207,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq46203){
var G__46204 = cljs.core.first(seq46203);
var seq46203__$1 = cljs.core.next(seq46203);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46204,seq46203__$1);
}));
...
var map__46225 = options;
var map__46225__$1 = (((((!((map__46225 == null))))?(((((map__46225.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46225.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46225):map__46225);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46225__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__46226 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46226,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46226,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46226,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46226,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46226,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46226,(5),null);
...
var o__45643__auto__ = f;
return (o__45643__auto__["getBasis"]).call(o__45643__auto__);
});
/**
...
}catch (e46233){var _e__45680__auto__ = e46233;
...
var G__46345 = (obj[cljs.core.first(path)]);
var G__46346 = cljs.core.rest(path);
obj = G__46345;
path = G__46346;
continue;
} else {
...
var temp__5752__auto__ = cljs.core.re_matches(/(.*)\$$/,key);
if(cljs.core.truth_(temp__5752__auto__)){
var m = temp__5752__auto__;
...
var _STAR_ = (function (accum,p__46238){
var vec__46239 = p__46238;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46239,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46239,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__46245){
var vec__46246 = p__46245;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46246,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46246,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46246,(2),null);
...
var post_process = (function (p__46254){
var vec__46255 = p__46254;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46255,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46255,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46253_SHARP_){
return (obj[cljs.core.first(p1__46253_SHARP_)]);
}),sorted_matches);
