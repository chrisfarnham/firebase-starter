...
return [(function (){var pred__57379 = cljs.core.instance_QMARK_;
var expr__57380 = reactive_val;
if(cljs.core.truth_((pred__57379.cljs$core$IFn$_invoke$arity$2 ? pred__57379.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__57380) : pred__57379.call(null,reagent.ratom.RAtom,expr__57380)))){
return "ra";
} else {
if(cljs.core.truth_((pred__57379.cljs$core$IFn$_invoke$arity$2 ? pred__57379.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__57380) : pred__57379.call(null,reagent.ratom.RCursor,expr__57380)))){
return "rc";
} else {
if(cljs.core.truth_((pred__57379.cljs$core$IFn$_invoke$arity$2 ? pred__57379.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__57380) : pred__57379.call(null,reagent.ratom.Reaction,expr__57380)))){
return "rx";
} else {
if(cljs.core.truth_((pred__57379.cljs$core$IFn$_invoke$arity$2 ? pred__57379.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__57380) : pred__57379.call(null,reagent.ratom.Track,expr__57380)))){
return "tr";
} else {
return "other";
}
