...
var len__4736__auto___46381 = arguments.length;
var i__4737__auto___46382 = (0);
while(true){
if((i__4737__auto___46382 < len__4736__auto___46381)){
args__4742__auto__.push((arguments[i__4737__auto___46382]));

var G__46383 = (i__4737__auto___46382 + (1));
i__4737__auto___46382 = G__46383;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq46323){
var G__46324 = cljs.core.first(seq46323);
var seq46323__$1 = cljs.core.next(seq46323);
var G__46325 = cljs.core.first(seq46323__$1);
var seq46323__$2 = cljs.core.next(seq46323__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46324,G__46325,seq46323__$2);
}));
...
var temp__5752__auto__ = cljs.core.first(cljs.core.first(group));
if(cljs.core.truth_(temp__5752__auto__)){
var tag = temp__5752__auto__;
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__46347_SHARP_){
return (!((cljs.core.meta(p1__46347_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46353__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e46358){var _e__45680__auto__ = e46358;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e46361){var _e__45680__auto__ = e46361;
return false;
}}
})())){
...
var temp__5752__auto__ = devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([obj], 0));
if(cljs.core.truth_(temp__5752__auto__)){
var atomic_markup = temp__5752__auto__;
...
var _STAR_current_state_STAR__orig_val__46363 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__46364 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__46364);

try{var map__46365 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46365__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__46363);
}});
...
var temp__5752__auto___46426 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5752__auto___46426)){
var managed_print_level_46427 = temp__5752__auto___46426;
var _STAR_print_level_STAR__orig_val__46368_46428 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__46369_46429 = managed_print_level_46427;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__46369_46429);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__46367_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__46367_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__46368_46428);
}} else {
job_fn();
}
