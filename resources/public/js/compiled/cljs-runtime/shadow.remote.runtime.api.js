...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_52276 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_52276(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_52277 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_52277(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_52278 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_52278(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_52282 = (function (thing,opts){
...
var temp__5752__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.meta(thing),cljs.core.with_meta(new cljs.core.Symbol("shadow.remote.runtime.api","describe","shadow.remote.runtime.api/describe",1388020131,null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("cljs.analyzer","no-resolve","cljs.analyzer/no-resolve",-1872351017),true], null)));
if(temp__5752__auto__){
var meta_impl__4427__auto__ = temp__5752__auto__;
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_52282(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_52283 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_52283(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_52284 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_52284(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__52270,callback){
...
var input = map__52271__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52271__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52271__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
