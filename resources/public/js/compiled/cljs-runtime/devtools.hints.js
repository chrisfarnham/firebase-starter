...
var temp__5752__auto__ = cljs.core.deref(devtools.hints.processed_errors);
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45899__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45899__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45899__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e45898){var _e = e45898;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5752__auto___45938 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5752__auto___45938)){
var seen_errors_45939 = temp__5752__auto___45938;
if(cljs.core.truth_(seen_errors_45939.has(self))){
} else {
seen_errors_45939.add(self);

var temp__5754__auto___45940 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5754__auto___45940)){
var sense_45941 = temp__5754__auto___45940;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_45941)].join(''));
} else {
}
}
} else {
...
var temp__5754__auto__ = devtools.hints.error_object_sense(error);
if(cljs.core.truth_(temp__5754__auto__)){
var sense = temp__5754__auto__;
