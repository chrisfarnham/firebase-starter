...
var G__46311 = devtools.prefs.pref(v);
v = G__46311;
continue;
} else {
return v;
...
}catch (e46263){var _e__45680__auto__ = e46263;
return false;
}})();
...
}catch (e46267){var _e__45680__auto__ = e46267;
return false;
}})();
...
}catch (e46270){var _e__45680__auto__ = e46270;
return false;
}}
}
});
...
var vec__46289 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46289,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46289,(1),null);
...
return cljs.core.some((function (p1__46293_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__46293_SHARP_);
}),template);
});
...
var temp__5752__auto__ = devtools.formatters.helpers.pref(pref_key);
if(cljs.core.truth_(temp__5752__auto__)){
var render_pref = temp__5752__auto__;
if(render_pref === true){
