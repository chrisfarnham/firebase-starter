...
var temp__5756__auto__ = reagent.impl.template.cache_get(reagent.impl.template.prop_name_cache,cljs.core.name(k));
...
var k_SINGLEQUOTE_ = temp__5756__auto__;
...
var G__57195 = o;
goog.object.set(G__57195,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__57244__i < G__57244__a.length) {G__57244__a[G__57244__i] = arguments[G__57244__i + 0]; ++G__57244__i;}
  args = new cljs.core.IndexedSeq(G__57244__a,0,null);
} 
...
if(reagent.impl.util.named_QMARK_(k)){
var temp__5756__auto__ = reagent.impl.template.cache_get(reagent.impl.template.custom_prop_name_cache,cljs.core.name(k));
if((temp__5756__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
...
var G__57201 = o;
goog.object.set(G__57201,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__57252__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__57252 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57253__i = 0, G__57253__a = new Array(arguments.length -  0);
while (G__57253__i < G__57253__a.length) {G__57253__a[G__57253__i] = arguments[G__57253__i + 0]; ++G__57253__i;}
  args = new cljs.core.IndexedSeq(G__57253__a,0,null);
} 
return G__57252__delegate.call(this,args);};
G__57252.cljs$lang$maxFixedArity = 0;
G__57252.cljs$lang$applyTo = (function (arglist__57260){
var args = cljs.core.seq(arglist__57260);
return G__57252__delegate(args);
});
G__57252.cljs$core$IFn$_invoke$arity$variadic = G__57252__delegate;
return G__57252;
})()
;
} else {
...
var G__57202 = props;
var G__57202__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57202,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__57202);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57202__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__57203 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57203,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__57203;
}
})(),id_class);
...
var G__57204 = (cljs.core.count(argv) - first_child);
switch (G__57204) {
case (0):
...
var vec__57205 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57205,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57205,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57205,(2),null);
...
var temp__5758__auto___57312 = reagent.impl.util.react_key_from_vec(v);
if((temp__5758__auto___57312 == null)){
} else {
var key_57313 = temp__5758__auto___57312;
(jsprops.key = key_57313);
}
...
var temp__5758__auto___57314 = reagent.impl.util.react_key_from_vec(v);
if((temp__5758__auto___57314 == null)){
} else {
var key_57315 = temp__5758__auto___57314;
(jsprops.key = key_57315);
}
...
var temp__5758__auto___57316 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5758__auto___57316 == null)){
} else {
var key_57317 = temp__5758__auto___57316;
(jsprops.key = key_57317);
}
...
var temp__5756__auto__ = reagent.impl.template.cache_get(reagent.impl.template.tag_name_cache,x);
if((temp__5756__auto__ == null)){
...
var temp__5758__auto___57320 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5758__auto___57320 == null)){
} else {
var key_57321 = temp__5758__auto___57320;
(jsprops.key = key_57321);
}
...
var temp__5758__auto___57322 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5758__auto___57322 == null)){
} else {
var key_57323 = temp__5758__auto___57322;
(jsprops.key = key_57323);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57214_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__57214_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__57215 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57215,(1),null);
...
break;
default:
var G__57328 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__57329 = compiler;
v = G__57328;
compiler = G__57329;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template57227 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template57227 = (function (opts,id,fn_to_element,meta57228){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template57227.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57229,meta57228__$1){
var self__ = this;
var _57229__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template57227(self__.opts,self__.id,self__.fn_to_element,meta57228__$1));
}));

(reagent.impl.template.t_reagent$impl$template57227.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57229){
var self__ = this;
var _57229__$1 = this;
return self__.meta57228;
}));

(reagent.impl.template.t_reagent$impl$template57227.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template57227.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template57227.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template57227.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template57227.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta57228","meta57228",359578350,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template57227.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template57227.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template57227");

(reagent.impl.template.t_reagent$impl$template57227.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template57227");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template57227.
 */
reagent.impl.template.__GT_t_reagent$impl$template57227 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template57227(opts__$1,id__$1,fn_to_element__$1,meta57228){
return (new reagent.impl.template.t_reagent$impl$template57227(opts__$1,id__$1,fn_to_element__$1,meta57228));
});

}

return (new reagent.impl.template.t_reagent$impl$template57227(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
