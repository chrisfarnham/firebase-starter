...
var G__46204 = cljs.core.next(xs);
var G__46205 = cljs.core.next(ys);
xs = G__46204;
ys = G__46205;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__46187 = val;
var G__46188 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__46187,G__46188) : f.call(null,G__46187,G__46188));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__46189 = val__$1;
var G__46190 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__46189,G__46190) : f.call(null,G__46189,G__46190));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__46191 = val__$1;
var G__46192 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__46191,G__46192) : f.call(null,G__46191,G__46192));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__46213 = cljs.core.next(es);
var G__46214 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__46213;
tcoll__$1 = G__46214;
continue;
} else {
...
var G__46215 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__46216 = cljs.core.next(es);
ret = G__46215;
es = G__46216;
continue;
} else {
