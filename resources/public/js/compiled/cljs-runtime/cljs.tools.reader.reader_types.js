...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_48455 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_48455(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_48461 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_48461(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_48464 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_48464(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_48468 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_48468(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_48469 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_48469(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_48472 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_48472(reader);
}
});
...
var self__ = this;
var reader__$1 = this;
var temp__5754__auto__ = self__.rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if(cljs.core.truth_(temp__5754__auto__)){
var ch = temp__5754__auto__;
...
var temp__5754__auto__ = new cljs.core.Keyword(null,"buffer","buffer",617295198).cljs$core$IFn$_invoke$arity$1(frames);
if(cljs.core.truth_(temp__5754__auto__)){
var buffer = temp__5754__auto__;
...
var G__48555 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__48556 = s.append(c);
c = G__48555;
s = G__48556;
continue;
}
